...
// Misc Settings (Facebook, Twitter, etc.)	
  ...
  $form['advanced_settings']['misc_settings']['fixed_header'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Fixed Header'),
    '#default_value' => theme_get_setting('fixed_header'),
    '#description'   => t("Enabled/Disable fixed header"),
  );	  
  
  $form['advanced_settings']['misc_settings']['breadcrumbs'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Breadcrumbs'),
    '#default_value' => theme_get_setting('breadcrumbs'),
    '#description'   => t("Enabled/Disable breadcrumbs"),
  );			  
  ...
  $form['advanced_settings']['misc_settings']['google'] = array(
    '#type' => 'textfield',
    '#title' => t('Google+ URL'),
	'#size' => 10,
  ...
  $form['advanced_settings']['misc_settings']['linkedin'] = array(
    '#type' => 'textfield',
  ...
  $form['advanced_settings']['misc_settings']['flickr'] = array(
    '#type' => 'textfield',
    '#title' => t('Flickr URL'),
	'#size' => 10,
